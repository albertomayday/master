...
class ProductionConfig:
    ...
    YOUTUBE_CHANNEL_IDS: List[str] = (
        os.getenv("YOUTUBE_CHANNEL_IDS", "").split(",") if os.getenv("YOUTUBE_CHANNEL_IDS") else []
    )
    ...
    SPOTIFY_ARTIST_IDS: List[str] = (
        os.getenv("SPOTIFY_ARTIST_IDS", "").split(",") if os.getenv("SPOTIFY_ARTIST_IDS") else []
    )
    SPOTIFY_PLAYLIST_IDS: List[str] = (
        os.getenv("SPOTIFY_PLAYLIST_IDS", "").split(",")
        if os.getenv("SPOTIFY_PLAYLIST_IDS")
        else []
    )
    ...
    LANDING_PAGE_URLS: List[str] = (
        os.getenv("LANDING_PAGE_URLS", "").split(",") if os.getenv("LANDING_PAGE_URLS") else []
    )
    ...
    def get_social_apis_config(cls) -> Dict[str, Dict[str, str]]:
        ...
        return {
            "youtube": {"api_key": cls.YOUTUBE_API_KEY, "channel_id": cls.YOUTUBE_CHANNEL_ID},
            "spotify": {
