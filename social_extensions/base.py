...
class BaseSocialAutomator(ABC):
    ...
    @abstractmethod
    async def get_metrics(self, start_date: datetime, end_date: datetime) -> SocialMediaMetrics:
...
class BaseActionGenerator(ABC):
    ...
    @abstractmethod
    async def analyze_performance(self, account_id: str, days: int = 7) -> Dict[str, Any]:
    ...
    async def generate_optimization_actions(
        self, current_metrics: SocialMediaMetrics, target_metrics: Dict[str, float]
    ...
    def get_performance_insights(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_action": (
                self.optimization_history[-1].created_at.isoformat()
...
class BaseMonitor(ABC):
    ...
    def get_alerts(
        self, severity: Optional[str] = None, resolved: bool = False
    ) -> List[Dict[str, Any]]:
...
class CrossPlatformManager:
    ...
    def get_overall_health(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "overall_health": (
                "healthy" if connected_count > 0 and total_alerts < 10 else "needs_attention"
            ),
        }
