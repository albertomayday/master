...
class TikTokCampaignConfig:
    ...
    content_types: List[str] = field(
        default_factory=lambda: ["in_feed", "brand_takeover", "hashtag_challenge"]
    )
...
class TikTokMusicalMLPredictor:
    ...
    def predict_performance(self, config: TikTokCampaignConfig) -> Dict[str, float]:
        ...
        genre_data = self.genre_performance_data.get(
            config.musical_context.genre, self.genre_performance_data[TikTokMusicalGenre.TRAP]
        )
...
async def simulate_tiktok_campaign():
    ...
    musical_context = TikTokMusicalContext(
        ...
        trending_sounds=["trap_beat_viral_2025", "808_slide_trending", "dark_melody_viral"],
        viral_hashtags=["#trapchallenge2025", "#808challenge", "#urbantiktok"],
        optimal_duration=20,
        target_demographics={
            "age_range": "16-25",
    ...
    for day in range(1, 6):
        ...
        daily_views = int(
            perf["estimated_views"] / campaign_config.campaign_duration * daily_performance_factor
        )
