...
class GranularTaggingSystem:
    ...
    def _initialize_sub_genres(self) -> Dict[str, SubGenreDefinition]:
        ...
        trap_subgenres = [
            {
                ...
                "bpm": (140, 160),
                "moods": ["agresivo", "introspectivo", "urbano"],
            ...
            },
            {
                ...
                "bpm": (130, 150),
                "moods": ["comercial", "romántico", "aspiracional"],
            ...
            },
            {
                ...
                "bpm": (135, 155),
                "moods": ["cultural", "festivo", "orgulloso"],
        ...
        reggaeton_subgenres = [
            ...
            },
            {
                ...
                "bpm": (95, 105),
                "moods": ["sexual", "festivo", "provocativo"],
            ...
            },
            {
                ...
                "bpm": (85, 95),
                "moods": ["comercial", "romántico", "mainstream"],
        ...
        rap_subgenres = [
            {
                ...
                "bpm": (80, 100),
                "moods": ["agresivo", "técnico", "underground"],
            ...
            },
            {
                ...
                "bpm": (75, 95),
                "moods": ["comercial", "aspiracional", "optimista"],
        ...
        collaborator_data = [
            {
                ...
                "boost": 2.5,
                "overlap": {"anuel_aa": 0.45, "daddy_yankee": 0.35},
            },
            {
                "id": "anuel_aa",
                "name": "Anuel AA",
                ...
                "regions": ["PR", "ES", "MX", "CO"],
                "boost": 2.0,
                "overlap": {"bad_bunny": 0.45, "ozuna": 0.40},
            },
            {
                "id": "daddy_yankee",
                "name": "Daddy Yankee",
                ...
                "boost": 2.2,
                "overlap": {"bad_bunny": 0.35, "don_omar": 0.50},
            },
            {
                "id": "j_balvin",
                "name": "J Balvin",
                ...
                "boost": 2.3,
                "overlap": {"maluma": 0.55, "karol_g": 0.40},
            },
            {
                "id": "peso_pluma",
                "name": "Peso Pluma",
                ...
                "regions": ["MX", "US"],
                "boost": 1.8,
                "overlap": {"natanael_cano": 0.60, "junior_h": 0.45},
            },
        ]
    ...
    def classify_sub_genre(
        self, main_genre: MainGenre, musical_elements: Dict
    ) -> Tuple[str, float]:
        """
        ...
        candidate_subgenres = [
            sg for sg in self.sub_genre_definitions.values() if sg.main_genre == main_genre
        ]
    ...
    def analyze_collaboration(self, collaboration_data: Dict) -> Dict[str, any]:
        ...
        if not collaborator_id or collaborator_id not in self.collaborator_profiles:
            return {"has_collaboration": False, "boost_factor": 1.0, "confidence": 0.0}
        ...
        type_multipliers = {"featuring": 1.0, "producer": 0.8, "songwriter": 0.6, "remix": 0.7}
        ...
        audience_expansion = {
            "estimated_new_reach": int(
                random.uniform(0.2, 0.4) * 1000000
            ),  # 200K-400K nuevos usuarios
    ...
    def _generate_audience_segments(
        self, main_genre: MainGenre, sub_genre_id: str, collaboration_analysis: Dict
    ) -> Dict[str, float]:
        ...
        segments = base_segments.get(
            main_genre,
            {"generic_music_fans": 0.60, "genre_explorers": 0.25, "trendfollowers": 0.15},
        )
    ...
    def _predict_market_performance(
        self, sub_genre_id: str, collaboration_analysis: Dict, musical_elements: Dict
    ) -> Dict[str, float]:
        ...
        predictions = {
            ...
            "virality_score": min(
                (base_modifier * collab_boost * energy_factor * dance_factor) / 2, 2.0
            ),
