...
from ..core.models import Device, GologinProfile, Task, get_db_session
        ...
        return jsonify(
            {
                ...
                "analysis": {
                    ...
                    "automation_confidence": analysis_result["automation_recommendations"][
                        "automation_confidence"
                    ],
                    "safe_actions": len(
                        analysis_result["automation_recommendations"]["safe_actions"]
                    ),
                    "risky_actions": len(
                        analysis_result["automation_recommendations"]["risky_actions"]
                    ),
                },
            }
        )
...
def api_yolo_create_task():
    ...
    try:
        ...
        task_def = create_task_definition(
            task_type=task_type,
            parameters={"device_serial": device_serial, **parameters},
